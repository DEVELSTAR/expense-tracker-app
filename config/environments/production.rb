...
Rails.application.configure do
  ...
  # Serve static files from the `/public` folder (required for Render)
  ...
  # Use STDOUT logger for Render (required for log aggregation)
  ...
  # Use memory store for cache (simpler for free tier, upgrade to Redis for production)
  config.cache_store = :memory_store

  # Use inline adapter for jobs (simpler for free tier, upgrade to Solid Queue for production)
